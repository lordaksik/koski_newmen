...
bot.hears('/bot', async (ctx) => {
   async function request2() {
      ...
      if(a1===30){
         ctx.reply("1 у красной кости не было  30 раз подряд");
      }
       if(a2===30){
         ctx.reply("2 у красной кости не было  30 раз подряд");
      }
       if(a3===30){
         ctx.reply("3 у красной кости не было  30 раз подряд");
      }
       if(a4===30){
         ctx.reply("4 у красной кости не было  30 раз подряд");
      }
       if(a5===30){
         ctx.reply("5 у красной кости не было  30 раз подряд");
      }
       if(a6===30){
         ctx.reply("1 у красной кости не было  30 раз подряд");
      }
       if(b1===30){
         ctx.reply("1 у синей кости не было  30 раз подряд");
      }
       if(b2===30){
         ctx.reply("2 у синей кости не было  30 раз подряд");
      }
       if(b3===30){
         ctx.reply("3 у синей кости не было  30 раз подряд");
      }
       if(b4===30){
         ctx.reply("4 у синей кости не было  30 раз подряд");
      }
       if(b5===30){
         ctx.reply("5 у синей кости не было  30 раз подряд");
      }
       if(b6===30){
         ctx.reply("6 у синей кости не было  30 раз подряд");
      }
