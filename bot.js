...
bot.hears('/bot', async (ctx) => {
   async function request2() {
      ...
      if(a1===24){
         ctx.reply("1 у красной кости не было  26 раз подряд");
      }
       if(a2===24){
         ctx.reply("2 у красной кости не было  26 раз подряд");
      }
       if(a3===24){
         ctx.reply("3 у красной кости не было  26 раз подряд");
      }
       if(a4===24){
         ctx.reply("4 у красной кости не было  26 раз подряд");
      }
       if(a5===24){
         ctx.reply("5 у красной кости не было  26 раз подряд");
      }
       if(a1===24){
         ctx.reply("1 у красной кости не было  26 раз подряд");
      }
       if(b1===24){
         ctx.reply("1 у синей кости не было  26 раз подряд");
      }
       if(b2===24){
         ctx.reply("2 у синей кости не было  26 раз подряд");
      }
       if(b3===24){
         ctx.reply("3 у синей кости не было  26 раз подряд");
      }
       if(b4===24){
         ctx.reply("4 у синей кости не было  15 раз подряд");
      }
       if(b5===24){
         ctx.reply("5 у синей кости не было  26 раз подряд");
      }
       if(b6===24){
         ctx.reply("6 у синей кости не было  26 раз подряд");
      }
